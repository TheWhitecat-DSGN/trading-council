...
def send_signal_message(analysis: dict) -> bool:
    ...
    if not token or not chat_id:
        print("[WARN] Telegram bot token or chat ID not set in config.py")
        print("[INFO] Signal would have been sent:")
...
def format_signal(analysis: dict) -> str:
    ...
    lines = [
        ...
        f"  • Price Action: {direction_emoji.get(pa_signal, '')} {pa_signal} ({pa_conf}%)",
